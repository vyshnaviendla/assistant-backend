...
//         await mongoose.connect('mongodb+srv://vyshnaviendla13:Vyshnavi456@cluster0.tnw00ra.mongodb.net/');
...
//         await mongoose.connect('mongodb+srv://lecture:Vyshnavi456@cluster0.niurqc4.mongodb.net/');
//         console.log('db connected!');
...
const db = async () => {
    ...
    try {
        ...
        await mongoose.connect('mongodb+srv://vyshnaviendla13:Nezuko@lecture.jbibwwp.mongodb.net/');
        console.log('db connected!');
